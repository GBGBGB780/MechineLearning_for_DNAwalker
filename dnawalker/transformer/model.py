# coding=utf-8
"""
dnawalker.transformer.model — PatchTST + MHA Transformer 逆向模型定义
dnawalker.transformer.model — PatchTST + MHA Transformer inverse model definition
...
def build_transformer_model(parent_config, transformer_config) -> "DNAWalkerTransformer":
    """
